...
extern void isr_wrapper32(void);
extern void isr_wrapper33(void);
extern void isr_wrapper34(void);
extern void isr_wrapper35(void);
extern void isr_wrapper36(void);
extern void isr_wrapper37(void);
extern void isr_wrapper38(void);
extern void isr_wrapper39(void);
extern void isr_wrapper40(void);
extern void isr_wrapper41(void);
extern void isr_wrapper42(void);
extern void isr_wrapper43(void);
extern void isr_wrapper44(void);
extern void isr_wrapper45(void);
extern void isr_wrapper46(void);
extern void isr_wrapper47(void);
...
int idt_init(void) {
    ...
    idt_set_gate(32, (u64)isr_wrapper32, 0x08, 0x8E);
    idt_set_gate(33, (u64)isr_wrapper33, 0x08, 0x8E);
    idt_set_gate(34, (u64)isr_wrapper34, 0x08, 0x8E);
    idt_set_gate(35, (u64)isr_wrapper35, 0x08, 0x8E);
    idt_set_gate(36, (u64)isr_wrapper36, 0x08, 0x8E);
    idt_set_gate(37, (u64)isr_wrapper37, 0x08, 0x8E);
    idt_set_gate(38, (u64)isr_wrapper38, 0x08, 0x8E);
    idt_set_gate(39, (u64)isr_wrapper39, 0x08, 0x8E);
    idt_set_gate(40, (u64)isr_wrapper40, 0x08, 0x8E);
    idt_set_gate(41, (u64)isr_wrapper41, 0x08, 0x8E);
    idt_set_gate(42, (u64)isr_wrapper42, 0x08, 0x8E);
    idt_set_gate(43, (u64)isr_wrapper43, 0x08, 0x8E);
    idt_set_gate(44, (u64)isr_wrapper44, 0x08, 0x8E);
    idt_set_gate(45, (u64)isr_wrapper45, 0x08, 0x8E);
    idt_set_gate(46, (u64)isr_wrapper46, 0x08, 0x8E);
    idt_set_gate(47, (u64)isr_wrapper47, 0x08, 0x8E);
