...
// Бесконечный цикл для idle-потока (не возвращает управление)
...
// Вспомогательные функции работы с очередями
...
void sched_init(void) {
    ...
    idle->regs.rsp = idle->kstack_top;
    idle->regs.rip = (u64)idle_loop;
